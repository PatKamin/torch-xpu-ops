...
macro(set_build_flags)
  message(STATUS "compiler id to:${CMAKE_CXX_COMPILER_ID} nazwa:${CMAKE_CXX_COMPILER}")
  if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    ...
    message(FATAL_ERROR "Not compiling with XPU. Currently only support GCC compiler on Linux and MSVC compiler on Windows as CXX compiler.")
    return()
  endif()
endmacro()
